...
void TensorProcessorImpl_GPU::AllocateAllDescriptorSets()
{
  ...
  buffersSize.descriptorCount          = 27 + 64; // + 64 for reserve
  ...
  layouts[0] = addDSLayout;
  layouts[1] = expDSLayout;
  layouts[2] = sumDSLayout;
  layouts[3] = matMulTransposeDSLayout;
  layouts[4] = copyDSLayout;
  layouts[5] = fillDSLayout;
  layouts[6] = copyDSLayout;
  layouts[7] = transposeDSLayout;
  layouts[8] = outer_productDSLayout;
  layouts[9] = smax_diffDSLayout;
  layouts[10] = padDSLayout;
  layouts[11] = conv2dDSLayout;
  layouts[12] = flipDSLayout;
  layouts[13] = max_poolDSLayout;
  layouts[14] = max_pool_diffDSLayout;
  layouts[15] = fillDSLayout;
  layouts[16] = dilateDSLayout;
  layouts[17] = urandDSLayout;
  layouts[18] = conv3dDSLayout;
  layouts[19] = max_pool_3DDSLayout;
  layouts[20] = max_pool_3D_diffDSLayout;
  layouts[21] = set_inputDSLayout;
  layouts[22] = get_outputDSLayout;
...
void TensorProcessorImpl_GPU::InitAllGeneratedDescriptorSets_process()
{
  ...
  //
  // descriptor set #0: addCmd (["memory.data()"])
  {
  ...
  // descriptor set #1: expCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #2: sumCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #3: matMulTransposeCmd (["memory.data()","memory.data()","memory.data()"])
  {
  ...
  // descriptor set #4: copyCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #5: fillCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #7: transposeCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #8: outer_productCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #9: smax_diffCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #10: padCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #11: conv2dCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #12: flipCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #13: max_poolCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #14: max_pool_diffCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #16: dilateCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #17: urandCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #18: conv3dCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #19: max_pool_3DCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
  ...
  // descriptor set #20: max_pool_3D_diffCmd (["memory.data()"])
  {
    constexpr uint additionalSize = 1;
...
void TensorProcessorImpl_GPU::InitAllGeneratedDescriptorSets_set_input()
{
  // now create actual bindings
  //
  // descriptor set #21: set_inputCmd (["in","memory"])
  {
    constexpr uint additionalSize = 1;
    ...
    writeDescriptorSet[2]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[2].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[2].dstSet           = m_allGeneratedDS[21];
    writeDescriptorSet[2].dstBinding       = 2;
    writeDescriptorSet[2].descriptorCount  = 1;
    writeDescriptorSet[2].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[2].pBufferInfo      = &descriptorBufferInfo[2];
...
void TensorProcessorImpl_GPU::InitAllGeneratedDescriptorSets_get_output()
{
  // now create actual bindings
  //
  // descriptor set #22: get_outputCmd (["out","memory"])
  {
    constexpr uint additionalSize = 1;
    ...
    writeDescriptorSet[2]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[2].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[2].dstSet           = m_allGeneratedDS[22];
    writeDescriptorSet[2].dstBinding       = 2;
    writeDescriptorSet[2].descriptorCount  = 1;
    writeDescriptorSet[2].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[2].pBufferInfo      = &descriptorBufferInfo[2];
